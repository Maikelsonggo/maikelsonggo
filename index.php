...
<body>
    <div class="container">
        <h1 class="title">WEBSITE MASTER FILM</h1>
        <form method="post" action="index.php">
            <div class="form-group">
                <input type="text" name="judul" class="form-control" placeholder="Cari film">
                <button type="submit" class="btn btn-primary" name="cari">TELUSURI</button>
            </div>
        </form>
        ...
        if(isset($_POST['cari'])){
            $judul = $_POST['judul'];
            echo "<h2 class='subtitle'>FILM DENGAN JUDUL '$judul'</h2>";
